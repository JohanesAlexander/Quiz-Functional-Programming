...
function getProductsByCategory(products, category) {
   ...
   */
  return products.filter(theProd => theProd.category === category);
}
...
function findProductById(products, id) {
  ...
  return products.filter(theProd => theProd.id === id);
}
...
function calculateTotalPrice(products) {
  ...
  //answer1
  // function sumPrice(total, products){
  //   return total + products.price;
  // }

  //const sumPrice = (total, product) => total + product.price; //alternative to use arrow function
  // return products.reduce(sumPrice,0);
  // end of answer 1
...
console.log(typeof(sampleProducts));
